# Stock Alerts — Portfolio Alert System
...
├── config/
│   ├── watchlist.json          # Tickers + custom triggers
│   └── portfolio.json          # Current positions (for SELL alerts)
├── data/
│   └── cache.json              # Yesterday's data
├── state/
│   └── cooldowns.json          # Alert cooldowns
...
```
Subject: Trading Signals — 3 BUY, 1 SELL — Dec 13
