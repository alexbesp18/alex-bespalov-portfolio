"""
Technical calculator for 009-alerts.
Extends shared_core.TechnicalCalculator with alert-specific processing methods.
"""
import pandas as pd
import numpy as np

try:
    from shared_core.market_data.technical import TechnicalCalculator as SharedTechnicalCalculator
except ImportError:
    # Fallback for standalone testing
    import sys
    sys.path.insert(0, str(__file__).replace('/009-alerts/src/calculator.py', '/000-shared-core/src'))
    from shared_core.market_data.technical import TechnicalCalculator as SharedTechnicalCalculator
...
class TechnicalCalculator(SharedTechnicalCalculator):
    ...
    Inherits: sma, ema, rsi, macd, bollinger_bands, atr, stochastic, adx, obv, etc.
    """
    ...
    def process_data(self, time_series_data):
        ...
        # ADX - use adx_series to get full Series for the DataFrame
