...
Core module for extracting investment themes and stock recommendations.
Refactored from the original investment_thesis.py with prompt loading support.
"""
...
FALLBACK_SYSTEM_PROMPT = """You are a senior equity research analyst at a major investment bank.
...
FALLBACK_USER_PROMPT = """You are a senior equity research analyst. Based on this podcast transcript,
...
class InvestmentThesisExtractor:
    ...
    Uses external prompt files for easy customization.
    ...
    PROMPT_PATH = "investment/base_thesis.md"
